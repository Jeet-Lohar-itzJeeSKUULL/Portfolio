      ...
      <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10" ref={containerRef}>
        ...
        >
          ...
          <p className="text-foreground/60 max-w-2xl mx-auto text-lg">
            A structured view of how I approach engineering, systems, and problem-solving.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 lg:gap-24 relative">
          ...
          <div className="flex flex-col pt-12 gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="space-y-3 text-foreground/80 leading-relaxed font-light text-base lg:text-lg">
                <p>
                  I’m a developer focused on building real-world applications that combine scalable systems, intuitive user experiences, and data-driven thinking.
                </p>
                <p>
                  My work sits at the intersection of full stack development, application engineering, and data science fundamentals — with a strong emphasis on building systems that perform reliably in real-world scenarios.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-2xl lg:text-3xl font-heading font-bold mb-4 text-accent">What I Think</h3>
              <div className="space-y-3 text-foreground/80 leading-relaxed font-light text-base lg:text-lg">
                <p>
                  I approach development with an engineering mindset — understanding the problem deeply before writing code.
                </p>
          ...
          <div className="flex flex-col md:pt-48 gap-12 lg:gap-16">
            ...
            >
              ...
              <div className="space-y-3 text-foreground/80 leading-relaxed font-light text-base lg:text-lg">
                <p>
                  I build full-stack web and mobile applications with a focus on performance, usability, and system design.
                </p>
                <p>
                  My experience includes developing backend systems, interactive frontends, and application-level architectures. I also integrate data science concepts to create smarter, more efficient solutions.
                </p>
              </div>
            </motion.div>
          </div>
